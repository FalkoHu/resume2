...
<%
    ...
    javax.servlet.http.Cookie cookie 
           = new javax.servlet.http.Cookie("type", request.getParameter("type").toString());
...
<html>
    <head>
        <title>Create Resume - IT Resume 4 U</title>
                        ...
                        <div class="row 200%">
                                ...
                                <form method="post" action="CreateResume">
                                    <div class="row uniform">
                                        <div class="6u 12u$(xsmall)">
                                            First Name: <input type="text" name="FIRSTNAME" value="" placeholder="First Name" required="true" />
                                        </div>
                                        <div class="6u 12u$(xsmall)">
                                            Last Name: <input type="text" name="LASTNAME" value="" placeholder="Last Name" required="true"/>
                                        </div>
                                        <div class="6u 12u$(xsmall)">
                                            Street Address: <input type="text" name="ADDRESS" value="" placeholder="Street Address" required="true"/>
                                        </div>
                                        <div class="6u 12u$(xsmall)">
                                            City: <input type="text" name="CITY" value="" placeholder="City" required="true"/>
                                        </div>
                                        <div class="6u 12u$(xsmall)">
                                            Zip Code: <input type="text" name="ZIP" value="" placeholder="Zip Code" required="true"/>
                                        </div>
                                        <div class="6u$ 12u$(xsmall)">
                                            Email: <input type="email" name="EMAIL" value="" placeholder="Email" required="true"/>
                                        </div>
                                        <div class="6u$ 12u$(xsmall)">
                                            Phone: <input type="text" name="PHONE" value="" placeholder="Phone" required="true"/>
                                        </div>
                                        <div class="6u$ 12u$(xsmall)">
                                            Objective: <TEXTAREA NAME="OBJECTIVE" ROWS="10" COLS="25" maxlength="250" style="resize: none" required="true" data-limit-rows="true" placeholder="Be brief, one or two sentences. &#10;&#10;Only fits 10 rows of text and 250 characters."></TEXTAREA>
                                        </div>
                                        ...
                                        <div class="6u 12u$(small)">
                                            <input type="radio" name="SCHOOLNAME" id="isu" VALUE="Illinois State University" required="true">
                                            <label for="isu">Illinois State University</label>
                                        </div>
                                        <div class="6u 12u$(small)">
                                            <input type="radio" name="SCHOOLNAME" id="another" VALUE="Another School" required="true">
                                            <label for="another">Another School</label>
                                        </div>
                                        <div class="12u$">
                                            <div class="6u 12u$(small)">University Location: <br>
                                                <input type="radio" name="SCHOOLLOC" id="SCHOOLLOC" VALUE="Bloomington-Normal" required="true">
                                                <label for="SCHOOLLOC">Bloomington-Normal</label>
                                            </div>
                                        </div>
                                        <div class="6u 12u$(small)"> Degree: <br/>
                                            <input type="radio" name="DEGREE" id="DEGREE1" VALUE="Degree of Science" required="true">
                                            <label for="DEGREE1">Degree of Science</label>
                                        </div>
                                        <div class="6u 12u$(small)"><br/>
                                            <input type="radio" name="DEGREE" id="DEGREE2" VALUE="Degree of Business" required="true">
                                            <label for="DEGREE2">Degree of Business</label>
                                        </div>
                                        <div class="6u 12u$(small)"> Major: <br/>
                                            <input type="radio" name="MAJOR" id="majorIS" VALUE="Information Systems" required="true">
                                            <label for="majorIS">Information Systems</label>
                                        </div>
                                        <div class="6u 12u$(small)"><br/>
                                            <input type="radio" name="MAJOR" id="majorBIS" VALUE="Business Information Systems" required="true">
                                            <label for="majorBIS">Business Information Systems</label>
                                        </div>
                                        <div class="3u 12u$(small)"> Grade Level: <br/>
                                            <input type="radio" name="YEAR" id="YEAR1" VALUE="Freshman" required="true">
                                            <label for="YEAR1">Freshman</label>
                                        </div>
                                        <div class="3u 12u$(small)"><br/>
                                            <input type="radio" name="YEAR" id="YEAR2" VALUE="Sophomore" required="true">
                                            <label for="YEAR2">Sophomore </label>
                                        </div>
                                        <div class="3u 12u$(small)"><br/>
                                            <input type="radio" name="YEAR" id="YEAR3" VALUE="Junior" required="true">
                                            <label for="YEAR3">Junior</label>
                                        </div>
                                        <div class="3u 12u$(small)"><br/>
                                            <input type="radio" name="YEAR" id="YEAR4" VALUE="Senior" required="true">
                                            <label for="YEAR4">Senior</label>
                                        </div>
                                        <!-- Break -->
                                        <div class="6u 12u$(small)">
                                            <div class="select-wrapper">
                                                <select name="GRADUATIONDATE" id="GRADUATIONDATE" required="true">
                                        ...
                                        <div class="6u 12u$(small)">
                                            <div class="select-wrapper">
                                                <select name="GRADUATIONYEAR" id="GRADUATIONYEAR" required="true">
                                        ...
                                        <div class="12u$">
                                            <div class="6u 12u$(small)">Grade Point Average (GPA): <br>
                                                <input type="text" name="GPA" value="" placeholder="GPA (X.XX)" maxlength="4" required pattern="\d.\d\d"  required="true" />
                                            </div>
                                            <DIV id="coursesIS" class="12u 12u$(small)">
                                        ...
                                        <DIV id="coursesBIS" class="6u 12u$(xsmall)">
                                            <H3>Please select the courses you would like to include:
                                            </H3>
                                            <br>
                                        ...
                                        <div id="tableIS" class="6u 12u$(xsmall)">
                                            <TABLE BORDER>

                                                <TR ALIGN=CENTER>
                                                    <TD> </TD>
                                                    <TD><B>No Experience</B></TD>
                                                    <TD><B>Little Experience</B></TD>
                                                    <TD><B>Well Experienced</B></TD>
                                                    <TD><B>Very Strong Experience</B></TD>
                                                </TR>
                                        ...
                                        <div class="jobss" >
                                            <div class="12u 12u$(xsmall)">
                                                Job Title: <INPUT TYPE="text" NAME="JOBTITLE" MAXLENGTH="80" required="true">
                                                Employer: <INPUT TYPE="text" NAME="EMPLOYER" MAXLENGTH="80" required="true">
                                            </div>
                                            <div class="12u 12u$(xsmall)">
                                                City: <INPUT TYPE="text" NAME="JOBCITY" MAXLENGTH=40 required="true">
                                                State: <INPUT TYPE="text" NAME="JOBSTATE" MAXLENGTH=40 required="true">
                                            </div>
                                            <div class="12u 12u$(xsmall)"><br>
                                                Start Date: <input id="date" type="date" NAME="STARTDATE" required="true">
                                                End Date: <input id="date" type="date" NAME="ENDDATE" required="true">
                                            </div>
                                            <div class="12u 12u$(xsmall)"><br>
                                                Description: <TEXTAREA NAME="DESCRIPTION" ROWS="9" COLS="58" maxlength="522" style="resize: none" required="true" data-limit-rows="true" placeholder="Describe your job in 3 lines or less, or if you are not adding a second job you have more room."></TEXTAREA>
                                            </div>
                                        </div>
                                        ...
                                        <div class="12u 12u$(small)">
                                            Custom Section Header: <INPUT TYPE="text" NAME="CUSTOMHEADER" MAXLENGTH=38 required="true" placeholder="Volunteer Experience">
                                        </div>
                                        <div class="12u 12u$(small)">
                                           Custom Section Content: <TEXTAREA NAME="CUSTOMCONTENT" ROWS="6" COLS="58" maxlength="348" style="resize: none" required="true" data-limit-rows="true" placeholder="This section is for whatever you want. Can only fit 6 rows maximum."></TEXTAREA>
                                        </div>
                                        <div class="6u 12u$(small)">
                            ...
                            <div class="6u$ 12u$(medium)">
                                ...
                                <span class="image fit">
                                    ...
                                    <% } else if (request.getParameter("type").equals("Traditional")) { %>
