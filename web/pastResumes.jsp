                        ...
                        <div class="row 200%">
                            <div class="6u 12u$(medium)">
                                            ...
                                            <table>
                                                ...
                                                <%
                                                    ...
                                                    try {
                                                        ...
                                                        ResultSet rs = st.executeQuery("select * from createdResumes WHERE username='" + user + "'");
                                                        while (rs.next()) {
                                ...
                                <div class="6u$ 12u$(medium)">
                                    ...
                                    <object width="500" height="700" data="CreateResume?view=view&id=30&type=Modern" id="resumeView"></object>
