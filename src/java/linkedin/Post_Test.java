...
public class Post_Test {
	...
	private static LinkedInProfile sendGet(String access_token) throws Exception {
		...
		String url = "https://api.linkedin.com/v1/people/~:(first-name,last-name,picture-url,email-address)?format=json";
		...
		obj_LinkedInProfile.setEmailAddress(jsonObj.getString("emailAddress"));
